...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light bg-info">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/Centennials/index.php" class="nav-link">Inicio</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/Centennials/Views/contacto.php" class="nav-link">Contacto</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-light-info elevation-4">
    <!-- Brand Logo -->
    <a href="/Centennials/index.php" class="brand-link">
